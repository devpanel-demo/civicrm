 ...
 *
config * Settings for Joomla 1.7.x - 2.5.x:
...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://' . getenv("DB_USER") . ':' . getenv("DB_PASSWORD") . '@' . getenv("DB_HOST").':'.getenv("DB_PORT") . '/' . getenv("DB_NAME") . '?new_link=true');
}
...
$civicrm_paths['civicrm.files']['url'] = 'http'.(empty($_SERVER['HTTPS'])?'':'s').'://'.$_SERVER['HTTP_HOST'].'/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://' . getenv("DB_USER") . ':' . getenv("DB_PASSWORD") . '@' . getenv("DB_HOST") .':'.getenv("DB_PORT") . '/' . getenv("DB_NAME") . '?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http'.(empty($_SERVER['HTTPS'])?'':'s').'://'.$_SERVER['HTTP_HOST']);
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'mK471Lq88dgvp3CwiFBTyP6RUo4SAXoAYi4TGOLNeg');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:2rDwRFfMFQY7g07j5ItFS8yHuvax7alymfdYXUYOrY0gFkQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:YIJ0YqcYVfCtMcHZAJwfnEKQ0vLfs0zAg4VlJZGJJl6RTWFbliOGuA');
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/web/sites/default/files/civicrm/templates_c/mail.log');
// }
